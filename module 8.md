...
3.Display the message "Enter a number from 1 to 9:".

4.Read the value of n from the user.

5.Use a switch statement to check the value of n.
...
7.If the entered number is not between 1 and 9, print "Greater than 9".
